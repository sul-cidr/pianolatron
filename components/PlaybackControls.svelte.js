...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			t35 = text("Accent");
			attr(div0, "class", "control svelte-16dxflf");
			attr(div1, "class", "control svelte-16dxflf");
			attr(div2, "class", "control svelte-16dxflf");
			attr(div3, "class", "control svelte-16dxflf");
			attr(div4, "class", "control svelte-16dxflf");
			attr(button0, "type", "button");
			attr(button0, "class", "svelte-16dxflf");
			attr(button1, "type", "button");
			attr(button1, "class", "svelte-16dxflf");
			attr(button2, "type", "button");
			attr(button2, "aria-pressed", button2_aria_pressed_value = /*$pedalling*/ ctx[6].soft);
			attr(button2, "class", "svelte-16dxflf");
			...
			attr(button3, "class", "svelte-16dxflf");
