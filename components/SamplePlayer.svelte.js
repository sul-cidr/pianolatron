/* src/components/SamplePlayer.svelte generated by Svelte v3.41.0 */
import {
	SvelteComponent,
	component_subscribe,
	init,
...
function instance($$self, $$props, $$invalidate) {
	...
	component_subscribe($$self, rollPedalingOnOff, $$value => $$invalidate(8, $rollPedalingOnOff = $$value));
	component_subscribe($$self, useMidiTempoEventsOnOff, $$value => $$invalidate(9, $useMidiTempoEventsOnOff = $$value));
	component_subscribe($$self, tempoCoefficient, $$value => $$invalidate(10, $tempoCoefficient = $$value));
	...
	component_subscribe($$self, activeNotes, $$value => $$invalidate(16, $activeNotes = $$value));
	...
	component_subscribe($$self, accentOnOff, $$value => $$invalidate(20, $accentOnOff = $$value));
	component_subscribe($$self, softOnOff, $$value => $$invalidate(21, $softOnOff = $$value));
	component_subscribe($$self, playExpressionsOnOff, $$value => $$invalidate(22, $playExpressionsOnOff = $$value));
	let tempoMap;
	let pedalingMap;
	let notesMap;
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*$tempoCoefficient*/ 1024) {
		...
		if ($$self.$$.dirty & /*$rollPedalingOnOff*/ 256) {
