...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(input, "class", "svelte-1n3tnys");
			attr(label, "for", label_for_value = `${/*id*/ ctx[0]}_collapse`);
			attr(label, "class", "svelte-1n3tnys");
			attr(div0, "style", div0_style_value = `width: ${/*width*/ ctx[1]};`);
			attr(div0, "class", "svelte-1n3tnys");
			attr(div1, "id", /*id*/ ctx[0]);
			attr(div1, "class", div1_class_value = "" + (null_to_empty(`flex-collapsible ${/*position*/ ctx[2]}`) + " svelte-1n3tnys"));
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*position*/ 4 && div1_class_value !== (div1_class_value = "" + (null_to_empty(`flex-collapsible ${/*position*/ ctx[2]}`) + " svelte-1n3tnys"))) {
